...
public class StreamAssignment {
    ...
    public void task8() {
        ...
        Optional<Person> optional = null;
        Comparator<Person> birthDate = (p1, p2) -> p1.getDateOfBirth().compareTo(p2.getDateOfBirth());

        optional = people.stream().min(birthDate);
    ...
    public void task10() {
        ...
        optional = people.stream()
                .filter(person -> person.getPersonId() == personId).findFirst()
                .map(person -> person.getDateOfBirth().format(DateTimeFormatter.ofPattern("eeee dd MMMM YYYY")).toUpperCase(Locale.ROOT));
    ...
    public void task12() {
        ...
        result = people.stream()
                .filter(person -> new StringBuilder(person.getFirstName().toLowerCase(Locale.ROOT)).reverse().toString().equals(person.getFirstName().toLowerCase(Locale.ROOT)))
    ...
    public void task14() {
        ...
        _2020_dates = Stream.iterate(LocalDate.of(year, 1, 1), day -> day.plusDays(1))
                .limit(LocalDate.of(year, 1, 1).isLeapYear() ? 366 : 365)
